...
INFINITY_MAINTAINER := "AeRocky"

# Poco X7 Pro supports Fingerprint On Display
TARGET_HAS_UDFPS := true

# Include Google Apps natively
WITH_GAPPS := true

# Infinity X Identity Flags
INFINITY_BUILD := rodin
INFINITY_DEVICE := rodin
TARGET_DEVICE := rodin
